...
from conf import test_data,pkl_data

d = pd.read_csv(test_data)

d1 = d.dropna(subset = ["label"])
...
import joblib
model_logit = joblib.load(pkl_data+'logistic_regression.pkl')

# Use the loaded model to make predictions
yhat=model_logit.predict(X)
log_prob = model_logit.predict_proba(X)
